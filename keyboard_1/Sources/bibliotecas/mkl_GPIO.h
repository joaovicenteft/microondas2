...
#ifndef C__USERS_RODRIGO_DESKTOP_CPPLINT_MASTER_MKL_GPIO_H_
#define C__USERS_RODRIGO_DESKTOP_CPPLINT_MASTER_MKL_GPIO_H_
...
#endif  //  C__USERS_RODRIGO_DESKTOP_CPPLINT_MASTER_MKL_GPIO_H_
