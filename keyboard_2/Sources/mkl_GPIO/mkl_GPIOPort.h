...
#ifndef C__USERS_RODRIGO_DESKTOP_CPPLINT_MASTER_MKL_GPIOPORT_H_
#define C__USERS_RODRIGO_DESKTOP_CPPLINT_MASTER_MKL_GPIOPORT_H_
...
#endif  //  C__USERS_RODRIGO_DESKTOP_CPPLINT_MASTER_MKL_GPIOPORT_H_
